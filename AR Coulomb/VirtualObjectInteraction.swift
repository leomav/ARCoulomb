...
//
//        guard var voiLongPressedEntity = virtualObjectInteraction?.longPressedEntity else {return}
//        guard var voiTrackedEntity = virtualObjectInteraction?.trackedEntity else {return}
